    ...
    <div class="flex-row a-c border-box flex-contain w90 h90">
      ...
      <div class="right w60 h90 flex-col a-c border-box">
        <div class="avatarSect flex-col a-c w60p">
          ...
          <p class="poppins darkTxt">
            Welcome, <br />
            Please signin to start your test
          </p>
        </div>
        ...
        <form action="" class=" flex-col a-c">
          ...
          <div class="cField-contain flex-row a-c w100p">
            <label class="poppins point label" for="english"
              >GNS111
              <input
                class="poppins point"
                type="checkbox"
            ...
            <label class="poppins point label" for="bus"
              >BUS103
              <input
                class="poppins point"
                type="checkbox"
            ...
            <label class="poppins point label" for="econs"
              >ECN101
              <input
                class="poppins point"
                type="checkbox"
            ...
            <label class="poppins point label" for="account"
              >ACC101
              <input
                class="poppins point"
                type="checkbox"
        ...
        <div
          class="startBtn poppins darkTxt bold  point"
          @click="showSelected()"
          v-if="showStartBtn"
        >
          START TEST
        ...
        <div
          :class="{
            'instruct-modal flex-col fix-mid curve-15-all big-card-shadow whiteBg border-box animated': true,
            fadeInRight: instructionDialog,
            fadeOutLeft: !instructionDialog
          }"
          v-show="instructionDialog"
        >
          <div class="flex-row a-c-n space-btw w100p">
            <i></i>
            <i
              class="fas fa-times-circle point darkTxt"
              style="margin: .7rem; color: rgba(0,0,0,.6);"
              @click="closeDialog()"
            ></i>
          </div>
...
export default {
  ...
  methods: {
    ...
    showSelected () {
      this.$store.commit('saveTestDetails', {
